...
public class CustomerDatabaseRepository implements CustomerRepository {
    ...
    public Optional<Customer> customerOfId(final CustomerId anId) {
        ...
        return customerJpaRepository.findById(UUID.fromString(anId.value()))
    ...
    public Optional<Customer> customerOfCpf(final Cpf cpf) {
        ...
        return customerJpaRepository.findByCpf(cpf.value())
                .map(CustomerEntity::toCustomer);
    }
    ...
    public Customer create(final Customer customer) {
        return customerJpaRepository.save(CustomerEntity.of(customer)).toCustomer();
    }
